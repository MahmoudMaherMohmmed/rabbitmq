...
$channel->basic_consume($vegetables_queue, $consumerTag, false, false, false, false, 'process_message');
...
function writeDataToFile($message)
{
    ...
    $file_path = 'uploads/' . strtolower(trim(str_replace(' ', '_', 'vegetables_'.$message->name)));
